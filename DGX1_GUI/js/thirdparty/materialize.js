  ...
  var Timepicker = function (_Component16) {
    ...
    _createClass(Timepicker, [{
      ...
      value: function _buildHoursView() {
        ...
        var $tick_disabled = $('<div class="timepicker-tick is-disabled"></div>');
        ...
        if (this.options.twelveHour) {
          ...
          for (var _i2 = 0; _i2 < 24; _i2 += 1) {
            if (this.options.enabledHours) {
              if (this.options.enabledHours.indexOf(_i2) == -1) {
                var _tick = $tick_disabled.clone();
              } else {
                var _tick = $tick.clone();
              }
              // console.log(this.options.enabledHours.indexOf(_i2));
            } else {
              var _tick = $tick.clone();
            }
      ...
      value: function setHand(x, y, roundBy5) {
        ...
        if (!this.options.enabledHours || this.options.enabledHours.indexOf(value) != -1) {
